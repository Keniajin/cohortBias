...
%%% Leave the Abstract empty if your article does not require one, please see the Summary Table for full details.
  ...
  and relative risk from their true value are mainly a function of test
  ...
  measure of exposure association close to the true relative risk, according to
  specific disease characteristics, especially its prevalence.
  ...
  But more prevalent diseases showed the presence of large bias towards null for
  the relative risk, even with near perfect diagnosis.
  This bias also get larger as incidence decrease.
...
<<R_row20_10,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row20_10,echo=FALSE,results='hide',include=FALSE>>=
...
<<R_row20_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row20_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<R_row20_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row20_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<R_row05_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row05_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<R_row05_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row05_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<R_row05_10,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row05_10,echo=FALSE,results='hide',include=FALSE>>=
...
<<data-load50_05,results='hide',echo=FALSE>>=
...
<<R_row50_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row50_05,echo=FALSE,results='hide',include=FALSE>>=
...
<<data-load50_01,results='hide',echo=FALSE>>=
load("../data/R_star_50_01.RData")
@

<<bias50_01,echo=FALSE,results='hide'>>=
## Incidence
fastbind.ith.rows <- function(i) rbindlist(lapply(R_star, "[", i, TRUE))
fastbound <- lapply(1:3, fastbind.ith.rows)
names(fastbound) <- c("Total bias", "Selection bias", "Misclassification bias")
...
<<R_row50_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR_row50_01,echo=FALSE,results='hide',include=FALSE>>=
...
<<data-load50_10,results='hide',echo=FALSE>>=
load("../data/R_star_50_10.RData")
@

<<bias50_10,echo=FALSE,results='hide'>>=
## Incidence
fastbind.ith.rows <- function(i) rbindlist(lapply(R_star, "[", i, TRUE))
fastbound <- lapply(1:3, fastbind.ith.rows)
names(fastbound) <- c("Total bias", "Selection bias", "Misclassification bias")
...
<<R50,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR50,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<R20,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR20,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<R05,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<RR05,w=8,h=8,echo=FALSE,results='hide',include=FALSE>>=
...
<<IncSe_10,echo=FALSE,results='hide',include=FALSE>>=
...
<<IncSe_10_18,echo=FALSE,results='hide',include=FALSE>>=

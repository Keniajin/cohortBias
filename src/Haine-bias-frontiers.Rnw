...
\textbf{Figure S1.} Selection and misclassification biases for incidence rate
according to sensitivity and specificity. Disease prevalence = 5\%.
\textbf{Figure S2.} Selection and misclassification biases for incidence rate
according to sensitivity and specificity. Disease prevalence = 20\%.
\textbf{Figure S3.} Selection and misclassification biases for risk ratio
according to sensitivity and specificity. Disease prevalence = 5\%; true risk
ratio = 3.
\textbf{Figure S4.} Selection and misclassification biases for risk ratio
according to sensitivity and specificity. Disease prevalence = 20\%; true risk
ratio = 3.

...
%%% Leave the Abstract empty if your article does not require one, please see the Summary Table for full details.
  ...
  the two time-points of follow-up.
  ...
  biases, respectively.
  The objective of this study was to evaluate the relative impact of selection
  and misclassification biases resulting from misclassification, together, on
  measures of incidence.

  Data sets from a hypothetical cohort study with two samples collected one
  month apart were simulated and analyzed based on specific test and disease
  characteristics, for a stable population over the follow-up time, and with no
  elimination of disease or clustering of observations.
  ...
  from its true value is a function of test specificity, and disease prevalence
  and incidence.
  Imperfect sensitivity to identify observations at risk and imperfect
  specificity to identify incident cases lead to under-estimation of the
...
\tiny
 \keyFont{ \section{Keywords:} misclassification, selection bias, bias (epidemiology),
   longitudinal study} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}
